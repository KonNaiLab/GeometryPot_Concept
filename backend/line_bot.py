...
def handle_message(event):# สถานะ ตั้งค่า โซล help<--+ defult massy
    ...
    if message.type == "text":
        ...
        if "!สถานะ"==space_separated_message[0] and len(space_separated_message)==2: #!สถานะ 1
            ...
            # !ตั้งค่า 1 ไฟ 0 5
            modedict={"หลอดไฟ":"light","ระดับความชื้น":"humid","อุณหภูมิ":"temp"}
            if space_separated_message[2]!="หลอดไฟ" and len(space_separated_message)==5:
            ...
            if space_separated_message[1]=="ข้อมูล" and len(space_separated_message)==2:
                ...
                data=setpot({"data":zone[space_separated_message[1]]["humid"]},space_separated_message[2],"humid")
                data=setpot({"data":zone[space_separated_message[1]]["temp"]},space_separated_message[2],"temp")
            return
